...
const CartScreen = ({
  ...
  return (
    <div className="min-h-screen bg-navy font-outfit text-white relative flex flex-col">
      ...
      <div className="flex-1 pt-24 px-5 pb-48 lg:pb-32 lg:px-8 lg:max-w-4xl lg:mx-auto lg:w-full overflow-y-auto animate-fade-in no-scrollbar">
        {cartItems.length === 0 ? (
      ...
      {cartItems.length > 0 && (
        <div className="fixed bottom-0 left-0 w-full p-6 bg-navy/95 backdrop-blur-xl border-t border-white/10 z-50 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
          <div className="max-w-[428px] lg:max-w-4xl mx-auto">
